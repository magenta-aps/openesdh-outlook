namespace OpenEsdh._2013.Excel
{
    ...
    using OpenEsdh._2013.Excel.Properties;
    ...
    public class OpenESDHRibbon : RibbonBase, IExcelView
    {
        private IExcelPresenter _presenter;
        ...
        public void Initialize()
        {
            try
            {
                this._presenter = TypeResolver.Current.Create<IExcelPresenter>(this);
                ...
                new ComAwareEventInfo(typeof(Microsoft.Office.Interop.Excel.AppEvents_Event), "WindowActivate").AddEventHandler(Globals.ThisAddIn.Application, new AppEvents_WindowActivateEventHandler(this.Application_WindowActivate));
            }
